...
import { TutorialCountAI } from './tutorialCont-ai.js';
...
Utility.ai = new TutorialCountAI(snapPoints.slice(3, 6), 40, 50, Utility.gameScene, deck1);
...
passButton.on('click', () => {
    if (Utility.tutorialIndex % 2 == 0) {
        ...
        Utility.tutorialText.text = Utility.tutorialTextsCont[Utility.tutorialIndex++];
...
const initTutorial = () => {
    ...
    Utility.ai.deck.addCard('./assets/WC3P1.png', 4, 3, 'Water', ['Water'], true);
    ...
    // Initialize tutorial
    Utility.tutorialText = Utility.drawText(Utility.tutorialTextsCont[Utility.tutorialIndex++], window.innerWidth / 2, window.innerHeight / 4, 'white', Utility.gameScene, 32);
