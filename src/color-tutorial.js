...
// Send the player to the next part of the game
const restart = () => {
    window.location.href = './game.html';
};

// Set up player and ai decks
const initTutorial = () => {
    deck1.addCard('./assets/FC1P0.png', 1, 0, 'Fire', ['Fire'], true);
    deck1.addCard('./assets/FC1P1.png', 2, 1, 'Fire', ['Fire'], true);

    deck1.addCard('./assets/WC1P0.png', 1, 0, 'Fire', ['Fire'], false);
    deck1.addCard('./assets/WC1P0.png', 1, 0, 'Fire', ['Fire'], false);
    ...
    // Set up the starting point for the tutorial
    Utility.tutorialIndex = 9;
